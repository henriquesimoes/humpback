...
int main(int argc, char *argv[]) {
   ...
   printf("Height distribuition\n");
   histogram(h.first);

   printf("Width distribution\n");
   histogram(w.first);

   printf("Heights with more than %d occurences (Height | Occurrences)\n", offset);
   most_frequent(h.second);

   printf("Widths with more than %d occurences (Width | Occurrences)\n", offset);
