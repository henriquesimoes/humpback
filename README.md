...
In this branch (`lcn`), the second solution code using our dataset is updated to use Local Contrast
Normalization (LCN). For a description of this strategy, see Goodfellow _et al._'s [Deep Learning book][11],
...
[11]: https://www.deeplearningbook.org/contents/applications.html
