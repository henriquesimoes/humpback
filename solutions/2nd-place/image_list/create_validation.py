...
def get_config():
    ...
    ap.add_argument('--train', type=str, required=True, help='Train set labels')
    ap.add_argument('--test_number', type=int, required=True, help="Test number for the output name")
